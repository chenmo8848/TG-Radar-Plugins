...
def setup(ctx: PluginContext):
    ...
    async def _(app, event, args):
        ...
        await ctx.reply(event, ui.panel("TG-Radar · 版本", [ui.section("信息", [ui.bullet("版本", __version__), ui.bullet("架构", "全解耦插件 · 双进程 · SQLite WAL"), ui.bullet("模式", app.config.operation_mode)])]), prefer_edit=False)
