PLUGIN_META = {
    ...
    "kind": "core",
    "config_schema": {
        "bot_filter": {"type": "bool", "default": True, "description": "是否过滤 bot 消息"},
    },
}

# FIX ARCH-05: import from telegram_utils (stable SDK layer) not core_service
from tgr.telegram_utils import (
    RuleHit,
    build_message_link,
    collect_rule_hits,
    display_sender_name,
